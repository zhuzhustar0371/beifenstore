          ...
          <div class="flex flex-col gap-phi-4 sm:flex-row sm:items-start">
            ...
            <div class="min-w-0 flex-1">
              ...
              <div class="mt-phi-4 flex items-center gap-phi-2">
                <button class="btn-inline btn-inline--accent" @click="openEdit(product)">编辑</button>
                <button class="btn-inline btn-inline--warning" :disabled="product.featured" @click="setFeatured(product)">
                  {{ product.featured ? "当前主推" : "设为主推" }}
                </button>
                <button class="btn-inline btn-inline--success" @click="toggleProduct(product)">
          ...
          <div class="space-y-phi-4">
            ...
            <div>
              ...
              <div class="flex items-center gap-phi-3">
                ...
                <button v-if="editForm.imageUrl" class="btn-inline btn-inline--danger" @click="editForm.imageUrl = ''">移除</button>
              </div>
...
:root:not(.dark) .products-pagination__status {
