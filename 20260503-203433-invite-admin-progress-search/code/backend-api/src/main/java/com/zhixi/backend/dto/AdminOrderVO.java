...
public class AdminOrderVO extends Order {
  ...
  public AdminOrderVO(Order order) {
    ...
    setRefundCompletedAt(order.getRefundCompletedAt());
    setRefundRequestStatus(order.getRefundRequestStatus());
    setRefundRequestReason(order.getRefundRequestReason());
    setRefundRequestAt(order.getRefundRequestAt());
    setRefundReviewAt(order.getRefundReviewAt());
    setRefundReviewRemark(order.getRefundReviewRemark());
    setRefundReviewAdminId(order.getRefundReviewAdminId());
