...
const DEFAULT_RULES = {
  ...
  inviteRules: [
    { label: '第1批3人', peopleRule: '每满3人为一批', ratioText: '100%', cashbackAmount: 10.00 },
    { label: '第2批3人', peopleRule: '每满3人为一批', ratioText: '20%', cashbackAmount: 2.00 },
    { label: '后续每批3人', peopleRule: '每满3人为一批', ratioText: '20%', cashbackAmount: 2.00 }
  ],
  settleCondition: '返现仅在订单已付款后结算',
  inviteCondition: '同一被邀请人只统计其首单，每满3人为一批，第1批100%，第2批及以后每批20%'
};
