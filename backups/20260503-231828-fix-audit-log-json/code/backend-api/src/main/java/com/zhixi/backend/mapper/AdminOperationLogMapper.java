...
public interface AdminOperationLogMapper {
  ...
  @Select("SELECT l.id,l.admin_id AS adminId,a.display_name AS adminName,a.username AS adminUsername,l.module,l.action,l.target_type AS targetType,l.target_id AS targetId,l.request_payload AS requestPayload,l.created_at AS createdAt " +
