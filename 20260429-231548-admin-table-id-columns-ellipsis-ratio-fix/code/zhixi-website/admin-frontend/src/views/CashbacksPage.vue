            ...
            <tr v-for="cashback in cashbacks" :key="cashback.id">
              ...
              <td class="wechat-transfer-column">
                <div class="transfer-ellipsis-cell">
                  <span v-overflow-title="cashback.outBatchNo || ''" class="text-ellipsis">{{ cashback.outBatchNo || "-" }}</span>
                  <small v-if="cashback.transferId" v-overflow-title="cashback.transferId" class="text-ellipsis">{{ cashback.transferId }}</small>
                </div>
              </td>
              <td class="wechat-transfer-column">
                <div class="transfer-ellipsis-cell">
                  <span v-overflow-title="cashback.outDetailNo || ''" class="text-ellipsis">{{ cashback.outDetailNo || "-" }}</span>
                  <small v-if="cashback.transferDetailId" v-overflow-title="cashback.transferDetailId" class="text-ellipsis">{{ cashback.transferDetailId }}</small>
                </div>
              </td>
              <td>
                <div class="transfer-cell">
