      ...
      <transition-group name="toast-slide" tag="div" class="refund-toast-stack__inner">
        ...
        >
          ...
          <div class="refund-toast-card__body">
            ...
            <p class="refund-toast-card__row" v-if="item.orderStatus === 'COMPLETED'">
              <span class="refund-toast-card__label">状态</span>
              <span class="refund-toast-card__value refund-toast-card__completed-warn">已确认收货后申请退款</span>
            </p>
            <p class="refund-toast-card__row">
...
.refund-toast-card__completed-warn {
  color: #fbbf24;
  font-weight: 800;
}
