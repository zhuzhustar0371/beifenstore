...
CREATE TABLE IF NOT EXISTS orders (
  ...
  refund_request_status VARCHAR(32) NOT NULL DEFAULT 'NONE',
  refund_request_reason VARCHAR(255) NULL,
  refund_request_at TIMESTAMP NULL,
  refund_review_at TIMESTAMP NULL,
  refund_review_remark VARCHAR(255) NULL,
  refund_review_admin_id BIGINT NULL,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
