...
const DEFAULT_RULE = {
  ...
  inviteRules: [
    { label: "第1批", peopleRule: "满3人", ratioText: "100%", cashbackAmount: 10 },
    { label: "第2批", peopleRule: "满3人", ratioText: "20%", cashbackAmount: 2 },
    { label: "第3批及以后", peopleRule: "每满3人", ratioText: "20%", cashbackAmount: 2 }
  ],
