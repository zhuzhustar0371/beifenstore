<template>
  <div class="relative min-h-screen overflow-hidden bg-spatial-mesh text-indigo-50">
    <canvas ref="trailCanvas" class="pointer-events-none fixed inset-0 z-0 h-full w-full" />
    ...
    <div class="relative z-10 flex min-h-screen flex-1 flex-col md:pl-20 lg:pl-64">
      <header class="sticky top-0 z-20 px-phi-4 py-phi-3 md:px-phi-5">
      ...
      <main class="flex-1 px-phi-4 pb-phi-5 pt-phi-3 md:px-phi-5">
